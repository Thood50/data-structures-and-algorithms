...
const sortPeopleBetter = (arr) => {
    ...
    arr.sort((a, b) => a.firstName.toLowerCase().localeCompare(b.firstName.toLowerCase()));
    return arr.sort((a, b) => a.lastName.toLowerCase().localeCompare(b.lastName.toLowerCase()));
};
...
const sortMeetingsByDay = (arr) => {
  ...
  return arr.sort((a, b) => a.dayOfWeek.toLowerCase().localeCompare(b.dayOfWeek.toLowerCase()));
};
...
const sortSchedule = (arr) => {
  return arr.sort((a, b) => {
      if(a.dayOfWeek.toLowerCase() === b.dayOfWeek.toLowerCase() && a.start === b.start) {
          return arr.sort((a, b) => {
              (a.end - a.start) > (b.end - b.start_)
          })
          ...
          return arr.sort((a, b) => {
              a.dayOfWeek.toLowerCase().localeCompare(b.dayOfWeek.toLowerCase());
          })
      }
  })
};
